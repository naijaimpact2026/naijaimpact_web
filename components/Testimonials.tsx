...
const testimonials = [
  {
    ...
    hue: 340,
    quote:
      'NaijaImpact replaced three apps I was using. The ajo feature alone saved our group so many arguments — everything is tracked and transparent now.',
    rating: 5,
  },
  {
  ...
  },
  {
    ...
    hue: 15,
    quote:
      'My ajo group switched from paper records to NaijaImpact. No more arguments about who paid and who did not. Everything is on the app.',
    rating: 5,
  },
  {
    name: 'Tunde Adeleke',
    ...
    hue: 130,
    quote:
      'I published my first online course on NaijaImpact and earned ₦180,000 in the first month. The platform makes creators feel valued.',
    rating: 5,
  },
]
