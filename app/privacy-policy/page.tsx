...
import {
    Shield, Lock, Eye, Database, Globe, Bell, Scale, AlertTriangle, ChevronRight,
    HeartHandshake, ClipboardList, Search, Target, Cookie, Share2, ArrowLeftRight,
    Archive, UserCheck, Baby, Link2, Megaphone, ScrollText, RefreshCw, Pin, CheckCircle2,
    Mail, Trash2,
} from 'lucide-react'
        ...
        <div className="min-h-screen bg-[#f0f2f5]">
            ...
            <div className="sticky top-0 z-20 border-b border-gray-200 shadow-sm"
                ...
                <div className="max-w-4xl mx-auto px-5 py-3 flex items-center justify-between gap-4">
                    ...
                    <Link href="/delete-account"
                        ...
                        <Trash2 className="w-3 h-3" /> Delete Account <ChevronRight className="w-3 h-3" />
                    </Link>
                </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto px-5 py-6">
                <div className="grid grid-cols-3 gap-3">
                    {[
                        { icon: Lock, label: 'Data Security', value: 'Bank-grade' },
                        { icon: ScrollText, label: 'Compliance', value: 'NDPA / NDPR' },
                        { icon: UserCheck, label: 'Your Rights', value: '8 Rights' },
            ...
            <div className="max-w-4xl mx-auto px-5 pb-10 space-y-4">
                    ...
                    <div key={section.number} className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                        ...
                        <div className="flex items-center gap-3 px-5 py-4 border-b border-gray-50"
                            ...
                            <div className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0"
                                ...
                                <section.icon className="w-4 h-4 text-emerald-700" />
                            </div>
                ...
                <div className="rounded-3xl overflow-hidden shadow-sm"
                    ...
                    <div className="px-6 py-8 text-center">
                        ...
                        <HeartHandshake className="w-9 h-9 mb-3 mx-auto text-white/80" />
