...
export default async function LessonPage({ params }: LessonPageProps)
{
    ...
    const { lesson, prevLesson, nextLesson, enrollment, totalLessons, courseTitle } = lessonData
                ...
                <div className="lg:col-span-1">
                    <div className="sticky top-4 bento-card noise-bg p-4 space-y-3 max-h-[calc(100vh-6rem)] overflow-y-auto">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="font-semibold text-sm">Course Lessons</h2>
                        </div>
                                ...
                                <div key={section.id}>
                                    ...
                                    <div className="space-y-0.5">
                                        {section.lessons.map((l, lIdx) =>
                                        {
                                            ...
                                            const isLastWatched = enrollment.last_lesson_id === l.id
                                            return (
                                                <Link
                                                    key={l.id}
                                                    href={`/app/learn/${courseId}/${l.id}`}
                                                    className={`flex items-center gap-2 px-2 py-1.5 rounded-lg text-xs transition-colors ${isActive
