    ...
    return (
        <div className="flex flex-col items-center justify-center h-full min-h-[55vh] px-8 text-center gap-5 bg-white">
            <div className="relative w-24 h-24 mb-2">
                ...
                <span className="absolute -top-1 -right-1 w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center text-sm animate-bounce delay-75">💬</span>
                <span className="absolute -bottom-1 -left-1 w-5 h-5 rounded-full bg-amber-100 animate-bounce delay-150 text-xs flex items-center justify-center">✨</span>
            </div>
